...
{{--                        <a href="">--}}
{{--                            <img style="max-width: 100%;width: 80px;height: 100px" src="http://127.0.0.1:8000{{ pare_url_file($item->options->image) }}">--}}
{{--                        </a>--}}
{{--                    </div>--}}
...
{{--        <p style="margin:2px 0;color: #333">Email : bathiet98@gmail.com</p>--}}
{{--        <p style="margin:2px 0;color: #333">Phone : 0372293187</p>--}}
{{--        <p style="margin:2px 0;color: #333">Face : <a href="https://www.facebook.com/bathiet.19111998">Nguyễn Bá Thiết</a></p>--}}
{{--    </div>--}}
{{--</div>--}}
